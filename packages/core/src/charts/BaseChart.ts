...
export abstract class BaseChart extends EventEmitter<AllChartEvents> {
  ...
  private static tooltip: d3.Selection<HTMLDivElement, unknown, HTMLElement, unknown> | null = null;
  ...
  public updateConfig(config: Partial<BaseChartConfig>): this {
    ...
    protected setupTooltip(): d3.Selection<HTMLDivElement, unknown, HTMLElement, unknown> {
